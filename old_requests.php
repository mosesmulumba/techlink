<?php
	...
	$sql_tasks = "SELECT * FROM tasks WHERE ICTstaffname='$ICTstaffname' AND status='Installed'";
			...
			<div class="page_ody">
				...
				<div class="second_menu">
					<table>
						...
						<tr>
							<td onclick='location.href="view_assignments.php"'> New requests </td>
						</tr>
						<table>
						<tr>
							...
							while($row = $query_tasks -> fetch_array()){
								echo "
									<tr>
										...
										<td>".$row['status']."</td>
										<td align='center'><a href=denie_installation.php?no=".$row['no']."> Unconfirmed </td>
