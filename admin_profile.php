					...
					<div class="profile_div">
								...
								<table>
									...
									<tr>
										...
										<td> 
											...
											<button onclick="window.location='admin_profile.php'"> Cancel </button>
										</td>
									</tr>
								</table>
							</form>
						...
						<?php }
							...
							if (isset($_POST['update'])) {
								...
								$sql_update = "UPDATE admin SET id='$id', firstname='$firstname', lastname='$lastname' WHERE no='$no'";
						...
						<?php }
							...
							if (isset($_POST['update_password'])) {
								...
								if(empty($old_password) AND empty($new_password) AND empty($repeat_new_password)){
									...
									$sql_update = "UPDATE admin SET username='$username' WHERE no='$no'";
									$query_update = $connection -> query($sql_update);
									...
									echo "<style>
										...
										echo ("<meta http-equiv='refresh' content='4;URL=admin_profile.php'");
									...
									$sql_update = "UPDATE admin SET username='$username', password='$new_password' WHERE no='$no'";
									$query_update = $connection -> query($sql_update);
