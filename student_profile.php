		...
		<div class="main_container">
			...
			<div class="page_ody">
				...
				<div class="second_menu">
					<table>
						<tr>
							<td onclick='location.href="home_student.php"'> Cancel </td>
						</tr>
					</table>
				</div>
					...
					<div class="profile_div">
						...
						<table class="information_table">
							...
							<tr>
								...
								<td> <?php echo "<b>".$_SESSION['regno']."</b>" ;?> </td>
							</tr>
							<tr>
								<td> Faculty: </td>
							...
							<tr>
								<td> Course: </td>
								<td> <?php echo "<b>".$_SESSION['course']."</b>" ;?> </td>
							</tr>
							<tr>
								<td> Username: </td>
						...
						?>
							...
							<form method="post">
								<table>
									...
									<tr>
										<td> Registration Number: </td>
										<td> <?php echo "<input type='text' name='regno' value='".$_SESSION['regno']."'" ;?> </td>
									</tr>
									<tr>
										<td> Faculty: </td>
									...
									<tr>
										...
										<td> 
											...
											<button onclick="window.location='student_profile.php'"> Cancel </button>
										</td>
									</tr>
								</table>
							</form>
						...
						<?php }
							...
							if (isset($_POST['update'])) {
								...
								$sql_update = "UPDATE student SET id='$id', firstname='$firstname', lastneme='$lastname', email='$email', regno='$regno', faculty='$faculty', course='$course', username='$username' WHERE no='$no'";
						...
						<?php }
							...
							if (isset($_POST['update_password'])) {
								...
								if(empty($old_password) AND empty($new_password) AND empty($repeat_new_password)){
									...
									$sql_update = "UPDATE student SET username='$username' WHERE no='$no'";
									$query_update = $connection -> query($sql_update);
									...
									echo "<style>
										...
										echo ("<meta http-equiv='refresh' content='4;URL=student_profile.php'");
									...
									$sql_update = "UPDATE student SET username='$username', password='$new_password' WHERE no='$no'";
									$query_update = $connection -> query($sql_update);
