					...
					<div class="menue_items">
						<table>
							<tr>
								...
								<td> <a href="home_staff.php" class="current"> ICT-Staff </a> </td>
				...
				<div class="body_content">
					...
					<div class="profile_div">
						...
						<table class="information_table">
							...
							<tr>
								<td> Contact: </td>
								<td> <?php echo "<b>".$_SESSION['contact']."</b>" ;?> </td>
							</tr>
							<tr>
								<td> Username: </td>
						...
						?>
							...
							<form method="post">
								<table>
									...
									<tr>
										<td> Contact: </td>
										<td> <?php echo "<input type='text' name='contact' value='".$_SESSION['contact']."'" ;?> </td>
									</tr>
									<tr>
										<td> Username: </td>
									...
									<tr>
										...
										<td> 
											...
											<button onclick="window.location='staff_profile.php'"> Cancel </button>
										</td>
									</tr>
								</table>
							</form>
						...
						<?php }
							...
							if (isset($_POST['update'])) {
								...
								$sql_update = "UPDATE staff SET id='$id', firstname='$firstname', lastname='$lastname', email='$email', contact='$contact', username='$username' WHERE no='$no'";
						...
						<?php }
							...
							if (isset($_POST['update_password'])) {
								...
								if(empty($old_password) AND empty($new_password) AND empty($repeat_new_password)){
									...
									$sql_update = "UPDATE staff SET username='$username' WHERE no='$no'";
									$query_update = $connection -> query($sql_update);
									...
									echo "<style>
										...
										echo ("<meta http-equiv='refresh' content='4;URL=staff_profile.php'");
									...
									$sql_update = "UPDATE staff SET username='$username', password='$new_password' WHERE no='$no'";
									$query_update = $connection -> query($sql_update);
