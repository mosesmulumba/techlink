		...
		<div class="main_container">
					...
					<div class="menue_items">
						<table>
							<tr>
								...
								<td> <a href="lecturer.php" class="current"> Users </a> </td>
			...
			<div class="page_ody">
				...
				<div class="second_menu">
					<table>
						<tr>
							<td onclick='location.href="add_lecturer.php"'> Add User </td>
						</tr>
						<tr>
							<td onclick='location.href="add_requests4.php"'>Request for a device</td>
						</tr>
					</table>
				</div>
							...
							while($row = $query_lecturer -> fetch_array()){
								echo "
									<tr>
										...
										<td>".$row['course']."</td>
										<td>".$row['username']."</td>
										<td align='center'> <a href=update_lecturer.php?no=".$row['no']."> Update </a> </td>
										<td align='center'> <a href=delete_lecturer.php?no=".$row['no']."> Delete </a> </td>
									</tr>
								";
							}
						?>
